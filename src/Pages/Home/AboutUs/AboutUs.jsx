...
const AboutUs = () => {
  return (
    <div className="container h-[720px] bg-black mx-auto rounded-3xl mt-20 mb-10">
      <Helmet>
        <title>InventiSync | Home</title>
      </Helmet>
      <h1 className="text-6xl font-bold text-white mb-10 text-center pt-20 w-3/4 mx-auto">
